...
extension Model {
    ...
    func attachSingleLayout(scene: SettingsScene) {
        ...
        case .whipClient:
            attachBufferedCamera(cameraId: scene.videoSource.whipClientCameraId, scene: scene)
        case .mediaPlayer:
    ...
    func isSceneVideoSourceActive(scene: SettingsScene) -> Bool {
        ...
        case .whipClient:
            return activeBufferedVideoIds.contains(scene.videoSource.whipClientCameraId)
        case .external:
