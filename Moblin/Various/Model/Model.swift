...
final class Model: NSObject, ObservableObject, @unchecked Sendable {
    ...
    private func backgroundRunLevel() -> BackgroundRunLevel {
        ...
        if database.chat.background || database.catPrinters.backgroundPrinting || database.moblink.relay.enabled {
            return .service(keepChatRunning: database.chat.background || database.catPrinters.backgroundPrinting,
