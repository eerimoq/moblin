...
class SettingsStreamReplay: Codable, ObservableObject {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.layoutPositioningLock, layout.positioningLock)
    ...
    required init(from decoder: Decoder) throws {
        ...
        layout.positioningLock = container.decode(.layoutPositioningLock, Bool.self, false)
