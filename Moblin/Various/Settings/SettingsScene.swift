...
class SettingsWidgetVTuber: Codable, ObservableObject {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.whipClientCameraId, videoSource.whipClientCameraId)
    ...
    required init(from decoder: Decoder) throws {
        ...
        videoSource.whipClientCameraId = container.decode(.whipClientCameraId, UUID.self, .init())
...
struct SettingsVideoSource {
    ...
    var whipClientCameraId: UUID = .init()
    ...
    func toCameraId() -> SettingsCameraId {
        ...
        case .whipClient:
            return .whipClient(id: whipClientCameraId)
        case .mediaPlayer:
    ...
    mutating func updateCameraId(settingsCameraId: SettingsCameraId) {
        ...
        case let .whipClient(id: id):
            cameraPosition = .whipClient
            whipClientCameraId = id
    ...
    func isNetwork(cameraId: UUID) -> Bool {
        ...
        case .whipClient:
            return cameraId == whipClientCameraId
        default:
            return false
        }
    }
