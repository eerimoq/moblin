...
class SettingsShow: Codable, ObservableObject {
    ...
    @Published var connectionTimeline: Bool = false
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encode(.connectionTimeline, connectionTimeline)
    ...
    required init(from decoder: any Decoder) throws {
        ...
        connectionTimeline = container.decode(.connectionTimeline, Bool.self, false)
