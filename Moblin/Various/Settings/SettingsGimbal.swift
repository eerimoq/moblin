...
class SettingsGimbal: Codable, ObservableObject {
    ...
    @Published var zoomSpeedEnabled: Bool = false
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.zoomSpeedEnabled, zoomSpeedEnabled)
    ...
    required init(from decoder: Decoder) throws {
        ...
        zoomSpeedEnabled = container.decode(.zoomSpeedEnabled, Bool.self, false)
