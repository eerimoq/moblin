...
struct WidgetScoreboardGolfGeneralSettingsView: View {
...
private struct GolfPlayerView: View {
    @ObservedObject var player: SettingsWidgetGolfScoreboardPlayer
    let updated: () -> Void
...
struct WidgetScoreboardGolfSettingsView: View {
    @ObservedObject var golf: SettingsWidgetGolfScoreboard
    let updated: () -> Void
