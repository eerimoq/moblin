...
private let versions = [
    Version(version: "35.3.0", date: "2026-09-25", changes: [
        "• Show Twitch anonymous gift subs. 🐛 G",
        "• Try to make background streaming work better when Camera preview quick button is on. 🐛 HeroHarmony",
        "• Remove RTMP drift tracking toggle.",
        "• Total ingests jitter buffer makeover.",
        "• Render emotes in alerts widget.",
        "• Alerts widget positioning with alignment.",
        "• Make hype train banner look better.",
        "• Fix emotes in /me. 🧑‍🏭 gabbloxen",
        "• Fix YouTube login cancelled crash.",
        "• Simplify Twitch login.",
        "• Less risk of logging out wrong Twitch stream.",
        "• Audio refactoring and remove unknown level. 🧑‍🏭 xcopy94",
        "• Kick access token in keychain. 🧑‍🏭 iChrilIRL",
        "• Make it possible to accept Kick \"cookies\" by allowing scrolling.",
        "• Make macro events set variables that following actions can use.",
        "• Fix quick button settings applied to wrong quick button. 🐛 HeroHarmony",
        "• Various changes to video capture setup.",
        "• Remove photo shoot connections and outputs from capture session.",
        "• Experimental native low light boost debug toggle. 🧑‍🏭 SM9();",
        "• Twitch EventSub reconnect when subscribe fails.",
        "• Subscribe to Twitch events in parallel.",
        "• Show sent shoutouts in chat and activity feed.",
        "• Downsample big .png LUTs to fit in texture. 🐛 Crash dump",
        "• LUTs loading optimizations.",
        "• Chat text font picker. 💡 Someone in chat",
        "• Toggle to only allow TTS when a bluetooth speaker is connected. 💡 HeroHarmony",
        "• Macro event variables usability.",
        "• Faster export and import, but slightly larger archives.",
        "• Make test to speech delay between messages work on iOS 27. Apple bug. 🐛 HeroHarmony",
        "• New raid search result sorting.",
        "• Show viewer count in Twitch raid search results.",
        "• Do not show null island in map widget.",
    ]),
    ...
    Version(version: "34.2138.0", date: "2026-09-06", changes: [
        ...
        "• Make quick button states work after settings import.",
        "• Use notification event instead of subscription events.",
        "• Send chat message macro action. 💡 Crozbo",
        "• Run macros in remote control assistant. 💡 Crozbo",
        "• Optionally show twitch watch streaks in chat. 💡 Grandin Kartsa and mikeful",
        "• Optionally turn off drift tracking in RTMP server streams for debugging.",
        "  • For Ticans testing.",
        "• Number of chat messages to show setting in chat widget.",
        "• Optionally show selected icon when face blurring. 💡 9philip and Tican",
        "• {bonding} variable. 💡 9philip and others",
        "• Show 1/x as value for exposure and do not use some values. 💡 Murrito",
        "• Make scene quick switch work with camera preview quick button enabled. 💡 xcopy94",
        "• Show device total CPU usage instead of Moblin process CPU usage.",
        "• Toggle to always attach camera preview to capture session.",
        "• Default video source as None instead of Screen capture.",
        "• Toggle to always attach photo shoot to capture session.",
        "• Make twitch announcements show in chat.",
        "• System monitor variable, {systemMonitor}, in debug section.",
        "• Lower CPU usage when enabled bluetooth devices are not nearby.",
        "• Chat phone mode. 💡 xcopy94",
        "• Big Twitch GIFs.",
        "• Gigantified Twitch emotes.",
        "• MacOS status menu icon.",
        "• Recording refactoring.",
        "• Optionally make all chat names same color. 💡 Tican",
        "• GoPro bluetooth. 🧑‍🏭 iChrisIRL",
        "• Activity feed.",
        "• Prefer still images over GIFs when animated emotes settings is off.",
        "• Fuzzy matching chat bot command arguments. 💡 xcopy94",
        "• Select control bar background image.",
        "• Remote control assistant can send text messages to streamer. 💡 3l3ktr0l4mpe",
        "• Optionally show Twitch shared chat events. 💡 Someone in Twitch chat",
    ]),
    Version(version: "34.2137.0", date: "2026-08-30", changes: [
        ...
        "• Drop old video frames and audio buffers.",
        "• Configurable delay per mic.",
        "  • Settings → Audio → Delays.",
        "• Probably less problems in recordings when having audio disruptions.",
        "• Select mic after importing settings.",
        "• Use gemini-3.5-flash-lite as default chat bot ai ask model.",
        "• Better chat bot ai ask error replies.",
        "• Show toast when Twitch/Kick/YouTube authentication tokens expires.",
        "• Delete unused authentication tokens on app startup.",
        "• Make remote control status icon in top right show correct color.",
        "• Let user know that MetalPetal does not work when Moblin is in background.",
        "• Truncate long Twitch chat messages before sending them. 🐛 Tican",
        "• Correct selected zoom button in web remote control.",
        "• More gimbal controls via remote control.",
        "• SEI timecodes refactoring.",
        "• Mobcam for using Moblin as a webcam in OBS. 💡 Tican",
        "• Italian translation updated. ✍️ Alfa",
        "• Make Mac screen capture colors look better with MetalPetal.",
    ]),
    ...
    Version(version: "33.1337.0", date: "2026-08-14", changes: [
        ...
        "• Save settings button. 💡 3l3ktr0l4mpe",
        "• Scene video source mirror toggle. 💡 ANDI_CUTBRAY",
        "• Keep a list of saved remote control assistant URLs to make it easier to switch. 💡 Kentar75",
        "• Click/tap control bar and GoPro page indicators to switch page. 💡 ANDI_CUTBRAY",
        "• Make sparkle effect easier to see.",
        "• Core Image or MetalPetal for graphics processing. 🧑‍🏭 💡 hilxen",
        "  • Select in Settings → Scenes → Graphics.",
        "• Chinese (HK) translation updated. ✍️ tkg2222",
        "• Send map course and speed over remote control.",
        "• Import settings via remote control.",
        "  • Assistant sends settings to streamer.",
        "• Make SRT client show ingests status in top right.",
        "• Bump official SRT lib to version 1.5.6.",
        "• Bump RIST lib to version v0.2.20.",
        "• Bump WHIP/WHEP lib to latest master.",
        "• Move high quality downsampling toggle to Graphics page.",
        "• Support for Black Shark Magcool Pro 5. 🧑‍🏭 Spillmaker",
        "• Stats (similar to text widget variables data) from remote control streamer to assistant. 🧑‍🏭 NoFuture",
        "• Make remote control streamer able to connect to localhost.",
        "• Software video decoding toggle in ingests settings.",
        "• Make debug logging setting take effect after import.",
        "• Fix memory leak in SRT server and client ingests. 🧑‍🏭 Claude",
        "• Fix RIST server ingest crash. 🧑‍🏭 Claude",
        "• Make more ingests successfully decode first received video frame. 🧑‍🏭 Claude",
        "• Rename Kick host to raid. 🧑‍🏭 iChrisIRL",
        "• Send reply if requested song via chat bot if not found.",
        "• Fix WHEP client and WHIP server ingests sometimes freeze. 🧑‍🏭 Claude",
        "• Fix RTSP client ingest sometimes having wrong timestamps. 🧑‍🏭 Claude",
        "• Fix RTMP sometimes fails to connect. 🐛 VazhnovPavel",
        "• Fix RTSP client ingest for H.265 from ffmpeg. 🧑‍🏭 Claude",
    ]),
    ...
    Version(version: "33.8.0", date: "2026-06-19", changes: [
        ...
        "• Support for OA6 DJI device. 🧑‍🏭 NoFuture and simon_offiziell",
        "• German translation updated. ✍️ MaurisonX",
        "• Enable HTTP proxy by default.",
        "  • To make browser widgets and builtin browser bond iOS network interfaces.",
        "  • Disable in debug settings.",
        "• Chinese Taiwan translation updated. ✍️ 一人HitoriGS —",
        "• Copy Twitch login state to duplicated stream.",
        "• Macro repeat setting. 💡 Chat",
        "  • Off, count or forever.",
        "• Rename interactive chat quick button to scrollable chat. 💡 xcopy94",
        "• DJI device OA6 video codec setting (HEVC or AVC). 🧑‍🏭 NoFuture",
        "• Chat bot command to send a message.",
        "  • Typically define an alias for it, say !tip.",
        "• Do not reset other widgets when changing image widget image. 💡 elmino",
        "• Show pars toggle in golf full scorecard widget settings. 💡 elmino",
        "• Fetch YouTube handle after logging in.",
        "• Disable YouTube fetch video id button if channel handle is empty.",
        "• -1, PAR and +1 score buttons in golf scoreboard remote control. 💡 Saschivus",
        "• Close macros panel on run toggle per macro. 💡 AUTdany",
        "• Track split distance. 🧑‍🏭 NoFuture",
        "  • Can be reset in settings or via chat bot command.",
        "• UTF-8 instead of ASCII in browser widget chat messages. 🧑‍🏭 thecoolrhyno",
        "• Position browser widgets at their configured scene positions in interactive mode. 💡 HappyFluffyTeddy",
        "  • For readable browser widget alerts using front cam when not mirrored to viewers.",
        "• Make it easier to select DJI device WiFi network. 🧑‍🏭 ParaisosPeloSul",
        "• Slightly more efficient browser widget video snapshotting.",
        "• Send speech to text transcript to browser widgets that wants them. 🧑‍🏭 thecoolrhyno",
        "• Reload browser widgets when entering foreground when not streaming.",
        "• Save interactive browsers quick button state persistently.",
        "• Optional distance, altitude, temperature and speed units in text widget. 🧑‍🏭 ParaisosPeloSul",
        "• Add {area} and {neighborhood} text widget variables. 🧑‍🏭 mvanhorn",
        "• Browser widget local only toggle. 💡 Many streamers",
        "• Unique stream and scene names when duplicating.",
        "• Do not interrupt mic when someone is calling.",
        "  • Configure Phone app notification to banner only for this to work.",
        "• Make chat messages from moderators easier to see. 💡 LunaMach",
        "• Make quick button browser background not opaque.",
        "  • Use browser widgets for transparent background.",
        "• YouTube jewels in chat? 💡 LunaMach",
    ]),
    ...
    Version(version: "33.6.0", date: "2026-05-25", changes: [
        ...
        "  • Settings → Streams → My stream → Preview stream.",
        "• Reconnect preview stream automatically.",
        "• Start/stop preview stream using remote control.",
        "• Confirm dialogs for live, record and preview stream toggles in web remote control.",
        "• Chinese Taiwan translation updated. ✍️ 一人HitoriGS —",
        "• Edit OBS media source input using OBS remote control. 🧑‍🏭 Ducker",
        "• Support for DJI Pocket 4 in DJI devices. 🧑‍🏭 Ducker",
        "• Support for HEVC in RTMP server using standard RTMP protocol (not eRTMP). 🧑‍🏭 Ducker",
        "• Replace log per live session with always writing logs to file. 💡 extremememes",
        "• New web remote control status section design.",
        "• Open directories in Finder on Mac.",
        "• Video preview in web remote control.",
        "• New logic for keeping track of Moblink relays.",
        "• Pomodoro timer widget.",
        "• Map widget size setting. 💡 ParaglidingLive.com | Marco",
        "• Adjusted golf scoreboard par and score picker ranges. 💡 elmino",
        "• Optionally show golf player colors. 💡 elmino",
        "• Fix HTTP content length value parsing. 🐛 SM9();",
        "• Fix Moblin SRT ACK of all packets. 🐛 SM9();",
        "• Make first MPEG-TS packet 188 bytes. 🐛 SM9();",
        "• More RTSP client input validation. 🐛  SM9();",
        "• Make H.265 work better in RTSP client. 🐛 Stiegi_Power",
        "• Add high quality downsampling experimental debug setting.",
        "  • Makes some widgets look better. Uses more CPU/GPU.",
        "• Scoreboard size setting.",
        "• Make \"Restore purchases\" button sync state with Apple servers.",
        "• New persistent storage.",
        "  • Will you lose your settings again???",
        "• Show live activity again when app is running in background.",
        "• Fix buffered video insertion order. 🐛 Copilot",
        "• Disable drift tracking for Mac screen capture to fix lag? 🐛 Copilot",
        "• Higher Mac screen capture latency.",
        "• Stealth mode in remote control. 🧑‍🏭 datagutt",
        "• Show date in log header.",
        "• Mask widget effect.",
        "• Chat emote combo widget. 💡 9philip",
        "• Fix minor (I think) RTMP server bugs. 🐛 Copilot",
        "• Plus and minus buttons to move points in the mask widget effect.",
    ]),
    ...
    Version(version: "33.4.0", date: "2026-05-03", changes: [
        ...
        "• German translation updated. ✍️ MaurisonX",
        "• Toggle to make audio level meter bigger. 💡 Kosta X",
        "  • Settings → Display → Big audio level meter.",
        "• RTSP client ingest URL examples.",
        "• Remove DLive.",
        "• Easier SRT URL paste in Create stream wizard. 💡 S1nGeN0r",
        "• Make Mac screen capture work better when there is no movement.",
        "• Skip TTS immediately instead of on word boundary. 💡 Murrito",
        "• Configurable chat widget height. 💡 mikeful and R•O•X•Y",
        "  • Not perfect, but better.",
        "• Replay layout settings. 💡 bananasplit",
        "• Chinese (HK) translation updated. ✍️ tkg2222",
        "• Make chat (and more) work after URL import. 🐛 Sylver",
        "• Toggle clock in modular scoreboard. 🧑‍🏭 jeromecornet",
        "• Pan and tilt gimbal with game controller thumb sticks. 💡 JohannesLiv",
        "• Macros. 💡 AUTdany",
        "  • Enable/disable scene buttons, switch scene, delay and more.",
        "• Improve remove background effect to avoid transparent dark details. 🧑‍🏭 Copilot",
        "• Disable periodic bitrate change by default.",
        "• Update gimbal preset by log pressing game controller button. 💡 JohannesLiv",
        "• Make scene and zoom preset button text slightly bigger. 💡 hilxen",
        "• Chinese Taiwan translation updated. ✍️ 一人HitoriGS —",
        "• Some translations updated. Formatting should work better.",
        "• Golf scoreboard. 💡 elmino",
        "• Toggle to enable gimbal tracking. Enabled by default. 💡 JohannesLiv",
        "• Fix pixellate state in remote control.",
        "• Make SRTLA keep alive timestamp parsing robust. 🐛 3l3ktr0l4mpe",
        "• Golf full scorecard scoreboard. 💡 Crozbo",
        "  • Requires a golf scoreboard to work.",
        "• Select scoreboard sport in create widget wizard.",
        "• Try to reload all DJI devices.",
        "• Trigger glasses and sparkle with chat bot command.",
        "• Refactor video presentation on screen.",
        "• Refactoring and fix motion and macro gimbal buttons.",
        "• Show rate control in top left.",
        "• Make DJI device settings easier to understand.",
        "• Macro chat bot command. 💡 Murr1to",
    ]),
    Version(version: "33.3.3", date: "2026-04-23", changes: [
        ...
        "• Adaptive bitrate enabled by default for RIST.",
        ...
        "• Use libRIST 0.2.13 (with some patches, same as before). 💡 johan1111",
